    ...
    <div class="content">
        <div class="page-inner">
            <div class="page-header">
                <h4 class="page-title">Thêm bàn ăn  </h4>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{route('admin.admin_quanlyban_store')}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                 
                                  <div class="col-md-6 mt-3">
                                    <label for="" >Tên bàn</label>
                                    <input type="text" class="form-control mt-2" placeholder="Nhập Tên" name="tenBan"required>
                                  </div>
                                  <div class="col-md-6 mt-3">
                                    <label for="" >Kích cỡ</label>
                                    <input type="number" class="form-control mt-2" placeholder="Nhập kích cỡ" name="size"required min="1" max="5">
                                  </div>
                                  <div class="col-md-6 mt-3">
