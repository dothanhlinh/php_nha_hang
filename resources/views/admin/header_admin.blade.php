<div class="main-header">
    ...
    <div class="logo-header" data-background-color="blue">
        ...
        <a href="index.html" class="logo">
            <img src="/assets/admins/examples/assets/img/logo.svg" alt="navbar brand" class="navbar-brand">
        </a>
            ...
            <ul class="nav nav-primary">
                ...
                <li class="nav-item">
                    <a data-toggle="collapse" href="#maps">
                        ...
                        <p>Quản lý Thực Phẩm</p>
                        <span class="caret"></span>
                    </a>
                    <div class="collapse" id="maps">
                        <ul class="nav nav-collapse">
                            <li>
                                <a href="{{route('admin.ql_loaimonan.lmonan_admin')}}">
                                    <span class="sub-item">Quản lý loại món ăn</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{route('admin.ql_monan.monan_admin')}}">
                                    <span class="sub-item">Quản lý món ăn</span>
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="base">
                        <ul class="nav nav-collapse">
                            <li>
                                <a href="{{route('admin.quanlydatban')}}">
                                    <span class="sub-item">Chưa xác thực</span>
                                </a>
                            </li>
                            <li>
