...
<section class="hero-wrap hero-wrap-2" style="background-image: url('/assets/fronts/images/bg_5.jpg');" data-stellar-background-ratio="0.5">
  ...
  <section class="ftco-section ftco-counter img" id="section-counter" style="background-image: url(/assets/fronts/images/bg_4.jpg);" data-stellar-background-ratio="0.5">
   <div class="container">
   ...
   <div class="container py-5">
    <div class="row py-2">
     <div class="col-md-12 text-center">
      ...
      <a href="#" class="btn btn-white btn-outline-white">Đặt Bàn Ngay</a>
    </div>
  </div>
  </div>
  </section>
